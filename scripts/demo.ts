...
async function main() {
	...
	console.log(' 当前 number 值 :', currentNumber.toString());
	console.log('');
	...
	console.log('increment 后的 number 值 :', numberAfterIncrement.toString());
	console.log('');

	// 6. 调用 setNumber
	console.log('6. 调用 setNumber(100)...');
	...
	console.log('setNumber 后的 number 值 :', numberAfterSet.toString());
	console.log('');
	...
	console.log(' 找到 ', events.length, ' 个 Incremented 事件 ');
